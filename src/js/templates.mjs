...
export function alertTemplate(alert) {
  ...
  <svg class="icon" focusable="false" aria-hidden="true"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="${sprintUrl}#alert-${alertType}"></use></svg>
  <div>
...
function vcAddressTemplate(data) {
  return `<section class="addressContainer">
...
export function vcDirectionsTemplate(data) {
  return `<p id="directionsEl">${data}</p>`;
}
